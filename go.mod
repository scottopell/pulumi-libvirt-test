module pulumi-libvirt-ubuntu

go 1.17

replace github.com/pulumi/pulumi-libvirt/sdk => /Users/scott.opell/scratch/pulumi-libvirt/sdk

require github.com/pulumi/pulumi/sdk/v3 v3.39.1

require github.com/pulumi/pulumi-libvirt/sdk v0.3.0
